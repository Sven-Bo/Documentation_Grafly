...
* [👋 Welcome to the Grafly add-in](README.md)
...
* [How to create a single chart](guides/how-to-create-a-single-chart.md)
* [How to create a dashboard](guides/how-to-create-a-dashboard.md)
* [How to update the add-in](guides/how-to-update-the-add-in.md)
...
* [Which operating systems and versions of Excel does Grafly work with?](faq/which-operating-systems-and-versions-of-excel-does-grafly-work-with.md)
* [Which chart types are supported in Grafly?](faq/which-chart-types-are-supported-in-grafly.md)
